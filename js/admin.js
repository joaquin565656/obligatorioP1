...
function cargarTablasReservas() {
  // Pendientes
  document.querySelector("#adminReservasPendientesTBody").innerHTML =
    cargarTablaPorIdEstado(sistema.ID_ESTADO_PENDIENTE);
  // Aprobadas
  document.querySelector("#adminReservasAprobadasTBody").innerHTML =
    cargarTablaPorIdEstado(sistema.ID_ESTADO_APROBADA);
  // Canceladas
  document.querySelector("#adminReservasCanceladasTBody").innerHTML =
    cargarTablaPorIdEstado(sistema.ID_ESTADO_CANCELADA);
}
  ...
  for (let concierto of conciertos) {
    trConcierto += `<tr>
            ...
            <td><input type = "checkbox" ${
              concierto.oferta ? "checked" : ""
            } disabled></checkbox> </td>
            <td>
            <div class="contenedorAcciones">
                <button type="button" onClick="abrirPopUpCrearConcierto('${
                  concierto.id
                }')" class="btnModificar">Modificar </button> 
                ${
                  !concierto.estado
